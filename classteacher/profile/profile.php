...
<div id="wrapper">
        ...
        <div class="navbar navbar-default navbar-static-top">
            <div class="container">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href=""><span>T</span>pes</a>
                </div>
        ...
        <div id="main-slider" class="flexslider">
            <ul class="slides">
              ...
              <li>
                ...
                <div class="flex-caption">
                    <h3>add class details<br><br></h3> 
					<a href="../add/addclass.php" class="btn btn-theme">Add</a>
                </div>
              </li>
              <li>
    ...
    <div id="view">  <a href="../add/addclass.php"><h3>ADD CLASS DETAILS</h3></a> </div>
	<div id="next">  <a href="../enable/enable.php"><h3>ENABLE OR DISABLE EVALUATION</h3></a> </div>
    <div id="down">  <a href="../viewclass/viewclass.php"><h3>VIEW REPORT</h3></a> </div>
	</section>
    </div> 
