...
<form id="form1" name="form1" method="post" action="hh.php">

<h4 style="text-align:center">select class
...
$query = "select distinct class from facultycourse where department='".$department."'";
